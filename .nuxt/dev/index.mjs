import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/h3@1.15.1/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/vue-bundle-renderer@2.1.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/devalue@4.3.3/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/vue@3.3.10_typescript@5.3.3/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/@unhead+ssr@1.11.20/node_modules/@unhead/ssr/dist/index.mjs';
import destr from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/destr@2.0.3/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/unenv@1.10.0/node_modules/unenv/runtime/fetch/index.mjs';
import { withQuery, joinURL, parseURL, withoutBase, getQuery } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/ufo@1.5.4/node_modules/ufo/dist/index.mjs';
import { klona } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/unstorage@1.15.0_db0@0.2.4_ioredis@5.5.0/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/unstorage@1.15.0_db0@0.2.4_ioredis@5.5.0/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/ipx@2.1.0/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/pathe@1.1.2/node_modules/pathe/dist/index.mjs';
import { hash } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/ohash@1.1.5/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/unhead@1.11.20/node_modules/unhead/dist/index.mjs';
import { unref, version } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/vue@3.3.10_typescript@5.3.3/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///Users/heyiping/Desktop/code/site/node_modules/.pnpm/@unhead+shared@1.11.20/node_modules/@unhead/shared/dist/index.mjs';
...
const _YVD0bCY7id = (function(nitro) {
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBase": "http://34.80.16.115:3000/api"
  },
  "ipx": {
    "baseURL": "/_ipx",
    "alias": {},
    "fs": {
      "dir": "/Users/heyiping/Desktop/code/site/public"
    },
    "http": {
      "domains": []
    }
...
const serverAssets = [{"baseName":"server","dir":"/Users/heyiping/Desktop/code/site/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/heyiping/Desktop/code/site"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/heyiping/Desktop/code/site/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/heyiping/Desktop/code/site/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/heyiping/Desktop/code/site/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/heyiping/Desktop/code/site/.data/kv"}));
...
const _5L4Zwu = lazyEventHandler(() => {
...
const _lazy_lchqVz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_lchqVz, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _5L4Zwu, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lchqVz, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"专业的外贸独立站，提供优质产品和服务"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"外贸独立站"};
...
const getClientManifest = () => import('file:///Users/heyiping/Desktop/code/site/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/heyiping/Desktop/code/site/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
